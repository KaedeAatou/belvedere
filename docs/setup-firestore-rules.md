...
> 2026-06-10 作成 / 想定所要 5 分 / 個人 Google アカウント `mygolanglearn@gmail.com` で実施
...
firebase login
# → ブラウザが開く → mygolanglearn@gmail.com を選択 → 承認
```
...
```bash
firebase login:list
# 出力に mygolanglearn@gmail.com が表示されれば OK
```
...
```bash
cd /Users/kagayayuuki/Projects/ai-agent-hackathon/infra
