...
const cols = ref({
  keep: [
    { id: 1, text: '新機能リリース後、社内利用が +60% 増えた。導線として効いている。', who: 'kaede', votes: 5, hot: true },
  ...
  problem: [
    ...
    { id: 6, text: 'ゴールのMが弱く、レビュー時に判定が割れた。', who: 'kaede', votes: 3, hot: false },
...
const actions = [
  ...
  { id: 'a3', text: '前回 TODO 「ペアプロを週2回」の現状調査', owner: 'kaede', due: 'Next D05', done: false },
];
