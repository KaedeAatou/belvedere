...
const seedRetroNotes: RetroNote[] = [
  // Keep
  { id: 'note-k1', workspaceId: WORKSPACE, sprintNumber: RETRO_SPRINT, column: 'keep', text: '新機能リリース後、社内利用が +60% 増えた。導線として効いている。', authorId: 'kagayayuuki', votes: ['kagayayuuki', 'okubo', 'uehara', 'hirai', 'hayashi'], createdAt: '2026-05-18T10:00:00+09:00', createdBy: 'kagayayuuki' },
  { id: 'note-k2', workspaceId: WORKSPACE, sprintNumber: RETRO_SPRINT, column: 'keep', text: 'AI形骸化チェックがプランニングで2件のスコープ漏れを事前に拾った。', authorId: 'uehara', votes: ['kagayayuuki', 'okubo', 'uehara', 'hirai'], createdAt: '2026-05-18T10:01:00+09:00', createdBy: 'uehara' },
  ...
  // Problem
  { id: 'note-p1', workspaceId: WORKSPACE, sprintNumber: RETRO_SPRINT, column: 'problem', text: 'Spike が長期 DOING に留まった。タイムボックスが弱い。', authorId: 'hirai', votes: ['kagayayuuki', 'okubo', 'uehara', 'hirai', 'hayashi'], createdAt: '2026-05-18T10:03:00+09:00', createdBy: 'hirai' },
  ...
  { id: 'note-p3', workspaceId: WORKSPACE, sprintNumber: RETRO_SPRINT, column: 'problem', text: 'ゴールのMが弱く、レビュー時に判定が割れた。', authorId: 'kagayayuuki', votes: ['kagayayuuki', 'okubo', 'uehara'], createdAt: '2026-05-18T10:05:00+09:00', createdBy: 'kagayayuuki' },
  ...
  { id: 'note-t1', workspaceId: WORKSPACE, sprintNumber: RETRO_SPRINT, column: 'try', text: 'Spikeに 1.5日のハードタイムボックス、超過時は自動でレトロ議題に。', authorId: 'okubo', votes: ['kagayayuuki', 'okubo', 'uehara', 'hirai', 'hayashi'], createdAt: '2026-05-18T10:07:00+09:00', createdBy: 'okubo' },
  { id: 'note-t2', workspaceId: WORKSPACE, sprintNumber: RETRO_SPRINT, column: 'try', text: 'BLOCKED に遷移したら理由必須にする（Belvedere AIで強制）。', authorId: 'uehara', votes: ['kagayayuuki', 'uehara', 'hirai', 'hayashi'], createdAt: '2026-05-18T10:08:00+09:00', createdBy: 'uehara' },
