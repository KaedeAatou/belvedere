...
function getStructuredOutput(role: AgentRole): unknown {
  switch (role) {
    ...
    case 'retrospective':
      return {
        tries: [
          { text: 'デイリーで「昨日詰まったこと」を必ず1人1つ言う', owner: '加賀谷', carryToTicket: 'WC-DAILY-S13-T1' },
  ...
  switch (role) {
    ...
    case 'daily':
      return [
        ...
        '  - WC-105 [urgent] チケット品質スコアのヘッダ常設化 / 加賀谷 / 進捗あり',
        '  - WC-106 [high]   PRレビューLLMチューニング / 林 / ⚠ 3日進捗なし',
        '  - WC-102 [med]    要約Bot Slack常駐 / 大久保 / 進捗あり',
        '  - WC-111 [low]    ペアプロ音声をGemini要約 / 加賀谷 / 進捗あり',
    ...
    case 'retrospective':
      return [
        ...
        '       owner: 加賀谷 / 転記先: WC-DAILY-S13-T1 (新規)',
